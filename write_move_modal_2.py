  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-slate-900/50 backdrop-blur-sm animate-in fade-in">
      <div className="bg-white rounded-[24px] w-full max-w-sm p-6 shadow-xl relative animate-in zoom-in-95">
        ...
        {step === "menu" ? (
          <div>
            <h2 className="text-xl font-bold mb-1">Move Money</h2>
            <p className="text-sm text-slate-500 mb-6">What would you like to do?</p>
            ...
            <div className="space-y-3">
              <button onClick={() => setStep("send")} className="w-full flex items-center gap-4 p-4 border border-slate-200 rounded-2xl hover:border-brand hover:bg-brand/5 transition-colors text-left group">
                 ...
                 <div>
                    ...
                    <div className="text-xs text-slate-500">Send to someone or another account</div>
                 </div>
              </button>
          ...
          <div>
            ...
            <div className="bg-blue-50 text-blue-800 p-3 rounded-xl text-sm mb-4 flex items-start gap-2 border border-blue-100">
               <Info className="w-5 h-5 shrink-0 mt-0.5" />
               <div>
                 <strong>Simulation only</strong><br/>
                 No real money will be transferred. Your Arezak balance will be updated internally.
               </div>
            </div>
